...
fn build_full_app(app_state: AppState) -> Router {
    ...
    Router::new()
        ...
        .route("/api/forms/{form_id}/check-submission", post(handlers::check_existing_submission))
        ...
        .route("/api/admin/forms/{form_id}/respondents", get(handlers::get_form_respondents))
