...
export default function FormPageV2() {
  ...
  const handleSubmit = async () => {
    ...
    for (let i = -1; i < (form?.sections.length || 0); i++) {
      if (!validateSection(i)) {
        alert(`Please complete all required fields in section ${i + 2}`);
        setCurrentSection(i);
        return;
      }
    }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#FFF5E1] via-[#FFEFD5] to-[#FFE4C4]">
      <div className="max-w-4xl mx-auto p-4 md:p-8">
        ...
        {/* Header Card */}
        <Card className="mb-6 shadow-lg border-[#A4C2A8]">
          <CardHeader className="bg-gradient-to-r from-[#1E5C8B] to-[#005EB8] text-white">
            ...
            {form.settings.progressBar !== false && currentSection >= -1 && (
              <div>
                ...
                <div className="w-full bg-gray-200 rounded-full h-2">
                  <div
                    className="bg-gradient-to-r from-[#7FB069] to-[#A4C2A8] h-2 rounded-full transition-all duration-300"
        ...
        <Card className="shadow-lg">
            ...
            <div className="space-y-6">
              ...
              {form.settings.confidentialityNotice && (
                <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4">
                  <p className="font-medium text-yellow-900">Confidentiality Notice</p>
                  <p className="text-yellow-800">{form.settings.confidentialityNotice}</p>
                </div>
              )}
              ...
              <div className="pt-4">
                <Button
                  onClick={handleNext}
                  className="w-full sm:w-auto bg-[#1E5C8B] hover:bg-[#005EB8] text-white"
                  size="lg"
                >
                  Begin Review
                </Button>
          ...
          <div className="flex justify-between mt-8 pt-6 border-t">
            ...
            {currentSection < totalSections - 1 ? (
              <Button
                onClick={handleNext}
                className="bg-[#1E5C8B] hover:bg-[#005EB8] text-white"
              >
                Next
              </Button>
            ) : currentSection === totalSections - 1 ? (
              <Button
                ...
                disabled={submitting}
                className="bg-[#7FB069] hover:bg-[#6FA058] text-white"
              >
